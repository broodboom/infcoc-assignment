...
namespace Decoder
{
    ...
    class WorkingParams
    {
        public const string studentNumberOne = "0966972"; // This must be filled.
        public const string studentNumberTwo = "0958779"; // This must be filled. Keep it "" if you are working alone.
